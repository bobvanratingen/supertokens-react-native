...
AuthHttpRequest.doRequest = (httpCall, config, url) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        doNotDoInterception =
            (typeof url === "string" &&
                !shouldDoInterceptionBasedOnUrl(url, AuthHttpRequest.config.apiDomain, AuthHttpRequest.config.cookieDomain)) ||
                (url !== undefined &&
                    typeof url.url === "string" && // this is because url can be an object like {method: ..., url: ...}
                    !shouldDoInterceptionBasedOnUrl(url.url, AuthHttpRequest.config.apiDomain, AuthHttpRequest.config.cookieDomain));
    }
    catch (err) {
...
export function onUnauthorisedResponse(preRequestIdToken) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            headers = Object.assign(Object.assign({ rid: AuthHttpRequest.rid }, headers), { "fdi-version": supported_fdi.join(",") });
