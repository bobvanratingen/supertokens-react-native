...
export default class AntiCSRF {
    ...
    static getAntiCSRFToken() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            function getAntiCSRFFromStorage() {
                return __awaiter(this, void 0, void 0, function* () {
                    let fromStorage = yield EncryptedStorage.getItem(TOKEN_KEY);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            function setAntiCSRFToStorage(antiCSRFToken, domain) {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    yield EncryptedStorage.setItem(TOKEN_KEY, valueToSet);
                });
            }
    ...
    static removeToken() {
        return __awaiter(this, void 0, void 0, function* () {
            AntiCSRF.tokenInfo = undefined;
            yield EncryptedStorage.removeItem(TOKEN_KEY);
        });
    }
}
