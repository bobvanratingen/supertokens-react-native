...
export default class AntiCSRF {
    ...
    static getAntiCSRFToken() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            function getAntiCSRFFromStorage() {
                return __awaiter(this, void 0, void 0, function* () {
                    let fromStorage = yield CustomAsyncStorage.getItem(TOKEN_KEY);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            function setAntiCSRFToStorage(antiCSRFToken, domain) {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    yield CustomAsyncStorage.setItem(TOKEN_KEY, valueToSet);
                });
            }
    ...
    static removeToken() {
        return __awaiter(this, void 0, void 0, function* () {
            AntiCSRF.tokenInfo = undefined;
            yield CustomAsyncStorage.removeItem(TOKEN_KEY);
        });
    }
}
